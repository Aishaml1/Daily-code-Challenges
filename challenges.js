...
console.log('Number 2:', addTwoNumbers('this will return NAN'))
console.log('Number 2:', addTwoNumbers(3,4))
...
// function called sumNumbers
//accepts a single array 
// add the numbers in the array 
// evaluate the value for === 0
// check the length of the array === 0 
...
console.log('Number 3',sumNumbers([10]))
...
// accepts quantity instead of known qauntity
// could be a string instead of an array
// can use a spread operator to pass in as a params 
// acts as the name of the para,, so you can do things to the param

// * SUDO 
// Delcare a function called addList 
// create a variable to store total 
// could use forEach or reduce 
  // forEach only works on arrays
  // reduce can't work on other datatypes
  // add elements all together
  // if else statements 
// else statement returns 0
...
// function named computeRemainder accepts (A, B,)
// 1st is the dividend and the 2nd is the divisor
// test if wither are zero
// if  B ===  0 
// return Infinity 
// A / B
// return remainder
...
console.log('Number 5:',computeRemainder (30,8))
...
console.log('Number 6:', range(-2,1,4,5))
console.log('Number 6:', range(9,4,5,4,5))
...
console.log('Number 7:',reverseUpcaseString('hello'))
...
//remove ends of string with first and last characters 
//.substring()

const removeEnds = (str) => {
return str.slice(1,-1) //1 slices the begining and -1 slices the end
}
console.log('Number 8:',removeEnds('fo'))
...
// .reduce
//intial value of an empty object  {}
//
...
console.log('Number 9:',charCount('hello'))
...
//an interger representing the number format
//a string representig the character used to 'pad'
// return string string to a min length
// numeric argument rep the length of 'pad' to string 
// length of interger converted to a string , return string 
//with 3rd arg. 
//parsInt 
//.join
...
console.log('Number 10:',formatWithPadding(1234, '*', 3))
/*-----------------------------------------------------------------------------
...
// return t or f depending on the string 
